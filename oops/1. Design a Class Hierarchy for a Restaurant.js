...
class FastFoodRestaurant extends Restaurant {
   ...
   */
  constructor(name, location, cuisine, specialOffers) {
...
class FineDiningRestaurant extends Restaurant {
   ...
   */
  constructor(name, location, cuisine, wineList) {
    super(name, location, cuisine);
...
class Cafe extends Restaurant {
   ...
   */
  constructor(name, location, cuisine, outdoorSeating) {
    super(name, location, cuisine);
...
// Test cases
function testRestaurantClasses() {
